<div class="page-header">
	<h1> <i class="fa fa-users" aria-hidden="true"></i> Copropietarios <small> administrador </small></h1>
</div>
<?php echo form_open()?>
	<div class="row">
		<div class="col-md-12 sub-menu">
			<div class="btn-group btn-group-md" role="group" aria-label="...">
				...
				<a href="#" data-href="<?php echo site_url( $this->uri->segment(1) . '/agregar' )?>" data-toggle="modal" data-target="#myModal" data-title="COPROPIETARIOS <small> agregar </small>" class="btn btn-default"> AGREGAR <i class="fa fa-plus" aria-hidden="true"></i> </a>
			</div>
		</div>
	</div>
				...
				<tr> 
					...
					<td data-title="OPCIONES" > <div class="dropdown clearfix"> 
						...
						<ul class="dropdown-menu" aria-labelledby=dropdownMenu3> 
							...
							<li><a href="#" data-href="<?php echo site_url('colaboradores/editar/' . $value['id_copropietario'])?>" data-toggle="modal" data-target="#myModal" data-title="COPROPIETARIOS <small>editar </small>" >EDITAR</a></li>					
						</ul> 
						</div></td>
					<td data-title="ELIMINAR"><?php
						if(!$value['es_root']){
							...
							&nbsp;<div class="material-switch pull-right">
								<input type="checkbox" name="eliminar[]" id="option<?php echo $value['id_copropietario']?>" value="<?php echo $value['id_copropietario']?>">
		                        <label for="option<?php echo $value['id_copropietario']?>" class="label-danger"></label>
		                    </div><?php
		                }?>
					</td> 
				</tr><?php
