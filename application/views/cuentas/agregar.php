...
<?php echo form_open(NULL, array("class" => "form-horizontal" , "autocomplete"=>"off"))?>
            ...
            <select name="tipo_cuenta" class="form-control">
                ...
                <optgroup label="TIPOS CUENTAS"><?php
                    foreach($tipos_cuentas as $value){
                        ?>
                        <option value="<?php echo $value['id_tipo_cuenta']?>" <?php echo set_select('tipo_cuenta',$value['id_tipo_cuenta'])?> ><?php echo $value['tipo_cuenta']?></option><?php
                    }?>                 
                </optgroup>
            </select>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <input type="text" class="form-control" name="codigo" maxlength="10" value="<?php echo set_value('codigo')?>" placeholder="CODIGO">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <input type="text" class="form-control" value="<?php echo set_value('nombre')?>" name="nombre" placeholder="NOMBRE">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <textarea class="form-control" rows="5" name="detalle" placeholder="DETALLE ..."><?php echo set_value('detalle')?></textarea>
        </div>
    </div>
